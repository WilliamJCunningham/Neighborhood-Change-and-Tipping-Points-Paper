...
fips = state_abbr_to_fips(iteration)
  ...
  df_2020_1$GEOID <- as.character(df_2020_1$GEOID)
  ...
  df_2010_1$GEOID <- as.character(df_2010_1$GEOID)
  ...
  df_2000_1$GEOID <- as.character(df_2000_1$GEOID)
  ...
  weights_2000_2010$GEOID <- as.character(weights_2000_2010$GEOID)
  weights_2000_2010$blk2010ge <- as.character(weights_2000_2010$blk2010ge)
  ...
  weights_2010_2020$GEOID <- as.character(weights_2010_2020$GEOID)
  weights_2010_2020$blk2020ge <- as.character(weights_2010_2020$blk2020ge)
  ...
  df_2010_2020_2 <- df_2010_2020_1 %>%
    mutate(across(2:17, ~. * df_2010_2020_1$weight))
  ...
  #combine dataframes
  merged_df <- merge(df_2000_2010_2020_3,df_2020_4, by="GEOID"#, all.x = TRUE, all.y = TRUE#
                     )
  
  merged_df <- merge(df_2010_2020_3,merged_df, by="GEOID"#, all.x = TRUE, all.y = TRUE#
                     )
  #export
